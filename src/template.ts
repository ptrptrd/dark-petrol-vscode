...
export default () => {
  return {
    ...
    "colors": {
      ...
      "editor.wordHighlightBackground"          : fg,
      "editor.wordHighlightBorder"              : fg,
      "editor.wordHighlightStrongBackground"    : fg,
      "editor.wordHighlightStrongBorder"        : fg,
      "editor.wordHighlightTextBackground"      : fg,
      "editor.wordHighlightTextBorder"          : fg,
      "editor.findMatchBackground"              : fg,
      "editor.findMatchForeground"              : fg,
      "editor.findMatchHighlightForeground"     : fg,
      "editor.findMatchHighlightBackground"     : fg,
      "editor.findRangeHighlightBackground"     : fg,
      "editor.findMatchBorder"                  : fg,
      "editor.findMatchHighlightBorder"         : fg,
      "editor.findRangeHighlightBorder"         : fg,
      "search.resultsInfoForeground"            : fg,
      "searchEditor.findMatchBackground"        : fg, 
      "searchEditor.findMatchBorder"            : fg, 
      "searchEditor.textInputBorder"            : fg,
      "editor.hoverHighlightBackground"         : fg,
      "editor.lineHighlightBackground"          : fg, 
      "editor.lineHighlightBorder"              : fg, 
      "editorWatermark.foreground"              : fg, 
      "editorUnicodeHighlight.border"           : fg, 
      "editorUnicodeHighlight.background"       : fg, 
      "editorLink.activeForeground"             : fg, 
      "editor.rangeHighlightBackground"         : fg, 
      "editor.rangeHighlightBorder"             : fg, 
      "editor.symbolHighlightBackground"        : fg, 
      "editor.symbolHighlightBorder"            : fg, 
      "editorWhitespace.foreground"             : fg, 
      "editorIndentGuide.background"            : fg, 
      "editorIndentGuide.background1"           : fg, 
      "editorIndentGuide.background2"           : fg, 
      "editorIndentGuide.background3"           : fg, 
      "editorIndentGuide.background4"           : fg, 
      "editorIndentGuide.background5"           : fg, 
      "editorIndentGuide.background6"           : fg, 
      "editorIndentGuide.activeBackground"      : fg, 
      "editorIndentGuide.activeBackground1"     : fg, 
      "editorIndentGuide.activeBackground2"     : fg, 
      "editorIndentGuide.activeBackground3"     : fg, 
      "editorIndentGuide.activeBackground4"     : fg, 
      "editorIndentGuide.activeBackground5"     : fg, 
      "editorIndentGuide.activeBackground6"     : fg, 
      "editorInlayHint.background"              : fg,
      "editorInlayHint.foreground"              : fg,
      "editorInlayHint.typeForeground"          : fg,
      "editorInlayHint.typeBackground"          : fg,
      "editorInlayHint.parameterForeground"     : fg,
      "editorInlayHint.parameterBackground"     : fg,
      "editorRuler.foreground"                  : fg,
      "editor.linkedEditingBackground"          : fg,
      // Editor Colors - Codelens
      "editorCodeLens.foreground"               : fg,
      // Editor Colors - Lightbulb
      "editorLightBulb.foreground"              : fg,
      "editorLightBulbAutoFix.foreground"       : fg,
      "editorLightBulbAi.foreground"            : fg,
      // Editor Colors - Matching Brackets
      "editorBracketMatch.background"                       : fg,
      "editorBracketMatch.border"                           : fg,
      ...
      "editorBracketPairGuide.activeBackground1"            : fg,
      "editorBracketPairGuide.activeBackground2"            : fg,
      "editorBracketPairGuide.activeBackground3"            : fg,
      "editorBracketPairGuide.activeBackground4"            : fg,
      "editorBracketPairGuide.activeBackground5"            : fg,
      "editorBracketPairGuide.activeBackground6"            : fg,
      "editorBracketPairGuide.background1"                  : fg, 
      "editorBracketPairGuide.background2"                  : fg, 
      "editorBracketPairGuide.background3"                  : fg, 
      "editorBracketPairGuide.background4"                  : fg, 
      "editorBracketPairGuide.background5"                  : fg, 
      "editorBracketPairGuide.background6"                  : fg, 
      // Editor Colors - Folding
      "editor.foldBackground"             : fg,
      "editor.foldPlaceholderForeground"  : fg,
      // Editor Colors - Overview Ruler
      "editorOverviewRuler.background"                    : fg,
      "editorOverviewRuler.border"                        : fg,
      ...
      "editorOverviewRuler.inlineChatInserted"            : fg,
      "editorOverviewRuler.inlineChatRemoved"             : fg,
      ...
      "editorGutter.background"                       : fg,
      "editorGutter.modifiedBackground"               : fg,
      "editorGutter.addedBackground"                  : fg,
      "editorGutter.deletedBackground"                : fg,
      ...
      "editorCommentsWidget.resolvedBorder"           : fg,
      "editorCommentsWidget.unresolvedBorder"         : fg,
      "editorCommentsWidget.rangeBackground"          : fg,
      "editorCommentsWidget.rangeActiveBackground"    : fg,
      "editorCommentsWidget.replyInputBackground"     : fg, 
      // Diff Editor Colors
      "diffEditor.insertedTextBackground"       : ui.git.added.hovered.background.hex(),
      "diffEditor.insertedTextBorder"           : ui.git.added.hovered.border.hex(),
      "diffEditor.removedTextBackground"        : ui.git.deleted.hovered.background.hex(),
      ...
      "diffEditor.insertedLineBackground"       : ui.git.added.hovered.background.hex(),
      "diffEditor.removedLineBackground"        : ui.git.deleted.hovered.background.hex(),
      "diffEditorGutter.insertedLineBackground" : ui.git.added.hovered.background.hex(),
      "diffEditorGutter.removedLineBackground"  : ui.git.deleted.hovered.background.hex(),
      ...
      "merge.currentHeaderBackground"                       : fg, 
      "merge.currentContentBackground"                      : fg, 
      "merge.incomingHeaderBackground"                      : fg, 
      "merge.incomingContentBackground"                     : fg, 
      "merge.border"                                        : fg, 
      "merge.commonContentBackground"                       : fg, 
      "merge.commonHeaderBackground"                        : fg, 
      ...
      "mergeEditor.change.background"                       : fg, 
      "mergeEditor.change.word.background"                  : fg, 
      "mergeEditor.conflict.unhandledUnfocused.border"      : fg, 
      "mergeEditor.conflict.unhandledFocused.border"        : fg, 
      "mergeEditor.conflict.handledUnfocused.border"        : fg, 
      "mergeEditor.conflict.handledFocused.border"          : fg, 
      "mergeEditor.conflict.handled.minimapOverViewRuler"   : fg, 
      "mergeEditor.conflict.unhandled.minimapOverViewRuler" : fg, 
      "mergeEditor.conflictingLines.background"             : fg, 
      "mergeEditor.changeBase.background"                   : fg, 
      "mergeEditor.changeBase.word.background"              : fg, 
      "mergeEditor.conflict.input1.background"              : fg, 
      "mergeEditor.conflict.input2.background"              : fg, 
      // Panel Colors
      "panel.background"                  : fg,
      "panel.border"                      : fg,
      "panel.dropBorder"                  : fg,
      "panelTitle.activeBorder"           : fg,
      "panelTitle.activeForeground"       : fg,
      "panelTitle.inactiveForeground"     : fg,
      "panelInput.border"                 : fg,
      "panelSection.border"               : fg,
      "panelSection.dropBackground"       : fg,
      "panelSectionHeader.background"     : fg,
      "panelSectionHeader.foreground"     : fg,
      "panelStickyScroll.background"      : fg,
      "panelStickyScroll.border"          : fg,
      "panelStickyScroll.shadow"          : fg,
      "panelSectionHeader.border"         : fg,
      "outputView.background"             : fg,
      "outputViewStickyScroll.background" : fg,
      // Status Bar Colors
      "statusBar.background": fg,
      "statusBar.foreground": fg,
      "statusBar.border": fg,
      "statusBar.debuggingBackground": fg,
      "statusBar.debuggingForeground": fg,
      "statusBar.debuggingBorder": fg,
      "statusBar.noFolderForeground": fg,
      "statusBar.noFolderBackground": fg,
      "statusBar.noFolderBorder": fg,
      "statusBarItem.activeBackground": fg,
      "statusBarItem.hoverForeground": fg,
      "statusBarItem.hoverBackground": fg,
      "statusBarItem.prominentForeground": fg,
      "statusBarItem.prominentBackground": fg,
      "statusBarItem.prominentHoverForeground": fg,
      "statusBarItem.prominentHoverBackground": fg,
      "statusBarItem.remoteBackground": fg,
      "statusBarItem.remoteForeground": fg,
      "statusBarItem.remoteHoverBackground": fg,
      "statusBarItem.remoteHoverForeground": fg,
      "statusBarItem.errorBackground": fg,
      "statusBarItem.errorForeground": fg,
      "statusBarItem.errorHoverBackground": fg,
      "statusBarItem.errorHoverForeground": fg,
      "statusBarItem.warningBackground": fg,
      "statusBarItem.warningForeground": fg,
      "statusBarItem.warningHoverBackground": fg,
      "statusBarItem.warningHoverForeground": fg,
      "statusBarItem.compactHoverBackground": fg,
      "statusBarItem.focusBorder": fg,
      "statusBar.focusBorder": fg,
      "statusBarItem.offlineBackground": fg,
      "statusBarItem.offlineForeground": fg,
      "statusBarItem.offlineHoverForeground": fg,
      "statusBarItem.offlineHoverBackground": fg,
      // Title Bar Colors
      "titleBar.activeBackground": fg,
      "titleBar.activeForeground": fg,
      "titleBar.inactiveBackground": fg,
      "titleBar.inactiveForeground": fg,
      "titleBar.border": fg,
      // Menu Bar Colors
      "menubar.selectionForeground": fg,
      "menubar.selectionBackground": fg,
      "menubar.selectionBorder": fg,
      "menu.foreground": fg,
      "menu.background": fg,
      "menu.selectionForeground": fg,
      "menu.selectionBackground": fg,
      "menu.selectionBorder": fg,
      "menu.separatorBackground": fg,
      "menu.border": fg,
      // Command Center Colors
      "commandCenter.foreground": fg,
      "commandCenter.activeForeground": fg,
      "commandCenter.background": fg,
      "commandCenter.activeBackground": fg,
      "commandCenter.border": fg,
      "commandCenter.inactiveForeground": fg,
      "commandCenter.inactiveBorder": fg,
      "commandCenter.activeBorder": fg,
      "commandCenter.debuggingBackground": fg,
      // Notification Colors
      "notificationCenter.border": fg,
      "notificationCenterHeader.foreground": fg,
      "notificationCenterHeader.background": fg,
      "notificationToast.border": fg,
      "notifications.foreground": fg,
      "notifications.background": fg,
      "notifications.border": fg,
      ...
      // Banner Colors
      "banner.background": fg,
      "banner.foreground": fg,
      "banner.iconForeground": fg,
      // Extension Colors
      "extensionButton.prominentForeground": fg,
      "extensionButton.prominentBackground": fg,
      "extensionButton.prominentHoverBackground": fg,
      "extensionButton.background": fg,
      "extensionButton.foreground": fg,
      "extensionButton.hoverBackground": fg,
      "extensionButton.separator": fg,
      "extensionBadge.remoteBackground": fg,
      ...
      // Quick Picker Colors
      "pickerGroup.border": fg,
      "pickerGroup.foreground": fg,
      "quickInput.background": fg,
      "quickInput.foreground": fg,
      "quickInputList.focusBackground": fg,
      "quickInputList.focusForeground": fg,
      "quickInputList.focusIconForeground": fg,
      "quickInputTitle.background": fg,
      // Keybinding Label Colors
      "keybindingLabel.background": fg,
      "keybindingLabel.foreground": fg,
      "keybindingLabel.border": fg,
      "keybindingLabel.bottomBorder": fg,
      "keybindingTable.headerBackground": fg,
      "keybindingTable.rowsBackground": fg,
      // Integrated Terminal Colors
      "terminal.background": fg,
      "terminal.border": fg,
      "terminal.foreground": fg,
      "terminal.ansiBlack": fg,
      "terminal.ansiBlue": fg,
      "terminal.ansiBrightBlack": fg,
      "terminal.ansiBrightBlue": fg,
      "terminal.ansiBrightCyan": fg,
      "terminal.ansiBrightGreen": fg,
      "terminal.ansiBrightMagenta": fg,
      "terminal.ansiBrightRed": fg,
      "terminal.ansiBrightWhite": fg,
      "terminal.ansiBrightYellow": fg,
      "terminal.ansiCyan": fg,
      "terminal.ansiGreen": fg,
      "terminal.ansiMagenta": fg,
      "terminal.ansiRed": fg,
      "terminal.ansiWhite": fg,
      "terminal.ansiYellow": fg,
      "terminal.selectionBackground": fg,
      "terminal.selectionForeground": fg,
      "terminal.inactiveSelectionBackground": fg,
      "terminal.findMatchBackground": fg,
      "terminal.findMatchBorder": fg,
      "terminal.findMatchHighlightBackground": fg,
      "terminal.findMatchHighlightBorder": fg,
      "terminal.hoverHighlightBackground": fg,
      "terminalCursor.background": fg,
      "terminalCursor.foreground": fg,
      "terminal.dropBackground": fg,
      "terminal.tab.activeBorder": fg,
      "terminalCommandDecoration.defaultBackground": fg,
      "terminalCommandDecoration.successBackground": fg,
      "terminalCommandDecoration.errorBackground": fg,
      "terminalOverviewRuler.cursorForeground": fg,
      "terminalOverviewRuler.findMatchForeground": fg,
      "terminalStickyScroll.background": fg,
      "terminalStickyScroll.border": fg,
      "terminalStickyScrollHover.background": fg,
      "terminal.initialHintForeground": fg,
      "terminalOverviewRuler.border": fg,
      "terminalCommandGuide.foreground": fg,
      // Debug Colors
      "debugToolBar.background": fg,
      "debugToolBar.border": fg,
      "editor.stackFrameHighlightBackground": fg,
      "editor.focusedStackFrameHighlightBackground": fg,
      "editor.inlineValuesForeground": fg,
      "editor.inlineValuesBackground": fg,
      "debugView.exceptionLabelForeground": fg,
      "debugView.exceptionLabelBackground": fg,
      "debugView.stateLabelForeground": fg,
      "debugView.stateLabelBackground": fg,
      "debugView.valueChangedHighlight": fg,
      ...
      "debugTokenExpression.type": fg,
      // Testing Colors
      "testing.runAction": fg,
      "testing.iconErrored": fg,
      "testing.iconFailed": fg,
      "testing.iconPassed": fg,
      "testing.iconQueued": fg,
      "testing.iconUnset": fg,
      "testing.iconSkipped": fg,
      "testing.iconErrored.retired": fg,
      "testing.iconFailed.retired": fg,
      "testing.iconPassed.retired": fg,
      "testing.iconQueued.retired": fg,
      "testing.iconUnset.retired": fg,
      "testing.iconSkipped.retired": fg,
      "testing.peekBorder": fg,
      "testing.peekHeaderBackground": fg,
      "testing.message.error.decorationForeground": fg,
      "testing.message.error.lineBackground": fg,
      "testing.message.info.decorationForeground": fg,
      "testing.message.info.lineBackground": fg,
      "testing.messagePeekBorder": fg,
      "testing.messagePeekHeaderBackground": fg,
      "testing.coveredBackground": fg,
      "testing.coveredBorder": fg,
      "testing.coveredGutterBackground": fg,
      "testing.uncoveredBranchBackground": fg,
      "testing.uncoveredBackground": fg,
      "testing.uncoveredBorder": fg,
      "testing.uncoveredGutterBackground": fg,
      "testing.coverCountBadgeBackground": fg,
      "testing.coverCountBadgeForeground": fg,
      // Welcome Page Colors
      "welcomePage.background": fg,
      "welcomePage.progress.background": fg,
      "welcomePage.progress.foreground": fg,
      "welcomePage.tileBackground": fg,
      "welcomePage.tileHoverBackground": fg,
      "welcomePage.tileBorder": fg,
      "walkThrough.embeddedEditorBackground": fg,
      ...
      "gitDecoration.ignoredResourceForeground": fg,
      "gitDecoration.conflictingResourceForeground": fg,
      "gitDecoration.submoduleResourceForeground": fg,
      // SCource Control Graph Colors
      "scmGraph.historyItemGroupLocal": fg,
      "scmGraph.historyItemGroupRemote": fg,
      "scmGraph.historyItemGroupBase": fg,
      ...
      "settings.dropdownBackground": fg,
      "settings.dropdownForeground": fg,
      "settings.dropdownBorder": fg,
      "settings.dropdownListBorder": fg,
      "settings.checkboxBackground": fg,
      "settings.checkboxForeground": fg,
      "settings.checkboxBorder": fg,
      "settings.rowHoverBackground": fg,
      "settings.textInputBackground": fg,
      "settings.textInputForeground": fg,
      "settings.textInputBorder": fg,
      "settings.numberInputBackground": fg,
      "settings.numberInputForeground": fg,
      "settings.numberInputBorder": fg,
      "settings.focusedRowBackground": fg,
      "settings.focusedRowBorder": fg,
      "settings.headerBorder": fg,
      "settings.sashBorder": fg,
      "settings.settingsHeaderHoverForeground": fg,
      // Breadcrumbs Colors
      "breadcrumb.foreground": fg,
      "breadcrumb.background": fg,
      "breadcrumb.focusForeground": fg,
      "breadcrumb.activeSelectionForeground": fg,
      "breadcrumbPicker.background": fg,
      // Snippets Colors
      "editor.snippetTabstopHighlightBackground": fg,
      "editor.snippetTabstopHighlightBorder": fg,
      "editor.snippetFinalTabstopHighlightBackground": fg,
      "editor.snippetFinalTabstopHighlightBorder": fg,
      // Symbol Icons Colors
      ...
      "debugIcon.breakpointDisabledForeground": fg,
      ...
      // Notebook Colors
      "notebook.editorBackground"                         : fg,
      "notebook.cellBorderColor"                          : fg,
      "notebook.cellHoverBackground"                      : fg,
      "notebook.cellInsertionIndicator"                   : fg,
      "notebook.cellStatusBarItemHoverBackground"         : fg,
      "notebook.cellToolbarSeparator"                     : fg,
      "notebook.cellEditorBackground"                     : fg,
      "notebook.focusedCellBackground"                    : fg,
      "notebook.focusedCellBorder"                        : fg,
      "notebook.focusedEditorBorder"                      : fg,
      "notebook.inactiveFocusedCellBorder"                : fg,
      "notebook.inactiveSelectedCellBorder"               : fg,
      "notebook.outputContainerBackgroundColor"           : fg,
      "notebook.outputContainerBorderColor"               : fg,
      "notebook.selectedCellBackground"                   : fg,
      "notebook.selectedCellBorder"                       : fg,
      "notebook.symbolHighlightBackground"                : fg,
      "notebookScrollbarSlider.activeBackground"          : fg,
      "notebookScrollbarSlider.background"                : fg,
      "notebookScrollbarSlider.hoverBackground"           : fg,
      "notebookStatusErrorIcon.foreground"                : fg,
      "notebookStatusRunningIcon.foreground"              : fg,
      "notebookStatusSuccessIcon.foreground"              : fg,
      ...
      "commentsView.resolvedIcon"   : fg,
      "commentsView.unresolvedIcon" : fg,
      "actionBar.toggledBackground" : fg,
      // Simple Find Widget
      "simpleFindWidget.sashBorder"             : fg,
      // SCM
      "scm.historyItemAdditionsForeground"      : fg,
      "scm.historyItemDeletionsForeground"      : fg,
      "scm.historyItemStatisticsBorder"         : fg,
      "scm.historyItemSelectedStatisticsBorder" : fg,
    }
  }
}
