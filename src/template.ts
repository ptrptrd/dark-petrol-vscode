...
export default () => {
  return {
    ...
    "colors": {
      ...
      // Quick Picker Colors
      "pickerGroup.border"                  : fg.hex(),
      "pickerGroup.foreground"              : fg.hex(),
      "quickInput.background"               : fg.hex(),
      "quickInput.foreground"               : fg.hex(),
      "quickInputList.focusBackground"      : fg.hex(),
      "quickInputList.focusForeground"      : fg.hex(),
      "quickInputList.focusIconForeground"  : fg.hex(),
      "quickInputTitle.background"          : fg.hex(),
